...
@ESIntegTestCase.ClusterScope(scope= ESIntegTestCase.Scope.TEST, numDataNodes = 3, numClientNodes = 0)
public class GracefulStopIT extends AbstractGracefulStopTestCase {
