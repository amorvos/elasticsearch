...
public class IndexShard extends AbstractIndexShardComponent implements IndicesClusterStateService.Shard {
    ...
    /**
     * Value for getAutoGeneratedTimestamp() if the document has an external
     * provided ID.
     */
    ...
    public IndexShard(ShardRouting shardRouting, IndexSettings indexSettings, ShardPath path, Store store, IndexCache indexCache,
                      MapperService mapperService, IndexFieldDataService indexFieldDataService,
    ...
    public void performTranslogRecovery(boolean indexExists) throws IOException {
        ...
        internalPerformTranslogRecovery(false, indexExists, UNSET_AUTO_GENERATED_TIMESTAMP);
    ...
    private EngineConfig newEngineConfig(EngineConfig.OpenMode openMode, long maxUnsafeAutoIdTimestamp) {
        ...
        return new EngineConfig(openMode, shardId,
            ...
            mapperService.indexAnalyzer(), codecService, shardEventListener, translogRecoveryPerformer, indexCache.query(), cachingPolicy, translogConfig,
